...
Firstly, I am going to reproduce the first plot illustrated on the `palmerpenguins` site, with slight modification. This is basically a scatter plot overlaid by ordinary-least-squares regression lines across species.
...
The second plot depicts the distributions of flipper length by sex and species through a beeswarm plot. Relatively few data points in each category due to stratification allow me to make use of this pretty-looking plot, which also shows individual observations.
